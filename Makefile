...
XCFLAGS = -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -fstack-protector-strong -fno-strict-overflow -fvisibility=hidden -fexcess-precision=standard -DRUBY_EXPORT -fPIE $(INCFLAGS) $(_RUBY_DEVEL_enabled:yes=-DRUBY_DEVEL=1)
USE_RUBYGEMS = yes
...
CARGO_TARGET_DIR=/workspace/d031c350-535d-4160-8cd6-9e3e237967bd/sessions/agent_b94cbae5-f6ea-467c-b9bb-59dd9be820d3/yjit/target
CARGO_BUILD_ARGS=
LDFLAGS =  $(CFLAGS) -L. -fstack-protector-strong -rdynamic -Wl,-export-dynamic
EXE_LDFLAGS = $(LDFLAGS)
EXTLDFLAGS = 
XLDFLAGS = -fstack-protector-strong -pie $(EXTLDFLAGS)
EXTLIBS =
...
DLDFLAGS = -Wl,--compress-debug-sections=zlib $(XLDFLAGS) $(ARCH_FLAG)
SOLIBS = $(MAINLIBS)
ENABLE_DEBUG_ENV = 
...
configure_args =  '--prefix=/usr/local' '--disable-install-doc'
#### End of variables
